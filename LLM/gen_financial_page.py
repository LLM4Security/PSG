...
# 指定目录的路径
directory_path = "/mnt/inside_15T/PPG_dataset/DeUEDroid_result/Financial"
...
for subdirectory in subdirectories:
    ...
    if os.path.exists(path+'uiHtml.json') and os.path.exists(path+'/cfgs'):
        ...
        path = '/mnt/inside_15T/PPG_dataset/DeUEDroid_abstract/Financial/'+subdirectory
        result = {}
        ...
        for i in tqdm(ui_dic.keys()):
            ...
            if os.path.exists(path+'/'+i):
                try:
                    ...
                    print(error_message)
            if not os.path.exists('/mnt/inside_15T/PPG_dataset/DeUEDroid_page/Financial/'+subdirectory):
                os.makedirs('/mnt/inside_15T/PPG_dataset/DeUEDroid_page/Financial/'+subdirectory)
            with open('/mnt/inside_15T/PPG_dataset/DeUEDroid_page/Financial/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                json.dump(result,f)
