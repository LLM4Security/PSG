        ...
        for file in tqdm(file_list):
            ...
            for i in doc_result.keys():
                ...
                try:
                    ...
                    print(error_message)
            if not os.path.exists('/home/jiuyan/PPG/AndroidBench_func_abstract/'+subdirectory):
                os.makedirs('/home/jiuyan/PPG/AndroidBench_func_abstract/'+subdirectory)
            with open('/home/jiuyan/PPG/AndroidBench_func_abstract/'+subdirectory+'/'+file.replace('/home/jiuyan/PPG/AndroidBench_template/'+subdirectory+'/', ''), 'w', encoding='utf-8') as f:
