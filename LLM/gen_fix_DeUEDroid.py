...
app_processing_log = './fix_normal_time.log'
        ...
        for file in tqdm(file_list):
            ...
            for i in doc_result.keys():
                ...
                try:
                    ...
                    # Optionally, print the error message to the console
                    print(error_message)
            if not os.path.exists('/mnt/inside_15T/PPG_dataset/DeUEDroid_fix_abstract/Normal/'+subdirectory):
                os.makedirs('/mnt/inside_15T/PPG_dataset/DeUEDroid_fix_abstract/Normal/'+subdirectory)
            with open('/mnt/inside_15T/PPG_dataset/DeUEDroid_fix_abstract/Normal/'+subdirectory+'/'+file.replace('/mnt/inside_15T/PPG_dataset/DeUEDroid_template/Normal/'+subdirectory+'/', ''), 'w', encoding='utf-8') as f:
