...
subdirectories = subdirectories[int(len(subdirectories)/2)+67+28+73+67+21+22:int(len(subdirectories)/2)+67+28+73+67+21+22+70]

time_limit_per_app = 20*60

app_processing_log = './Normal_time.log'
