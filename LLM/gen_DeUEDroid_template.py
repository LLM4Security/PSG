        ...
        if os.path.exists(path):
            ...
            for i in file_list:
                with open(path + '/' + i,'r') as f:
                    dot_graph = f.read()
                if not os.path.exists('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_template/'+subdirectory):
                    os.makedirs('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_template/'+subdirectory)
                try:
                    with open('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_template/'+subdirectory+'/'+i[:-4],'w') as output_file:
