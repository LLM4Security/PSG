...
for subdirectory in tqdm(subdirectories):
    ...
    if os.path.exists(path+'uiHtml.json'):
        ...
        path = '/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_fix_abstract/'+subdirectory
        result = {}
        ...
        for i in tqdm(ui_dic.keys()):
            ...
            if os.path.exists(path+'/'+i):
                try:
                    ...
                    print(error_message)
            if not os.path.exists('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_fix_page/'+subdirectory):
                os.makedirs('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_fix_page/'+subdirectory)
            with open('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_fix_page/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                json.dump(result,f)
