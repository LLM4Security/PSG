...
# 指定目录的路径
directory_path = "/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DescribeCTX_result"
...
for subdirectory in tqdm(apk_name):
    ...
    if os.path.exists(path+'uiHtml.json') and os.path.exists(path+'/cfgs'):
        ...
        path = '/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/describeCtx_abstract/'+subdirectory
            ...
            for i in tqdm(ui_dic.keys()):
                ...
                if os.path.exists(path+'/'+i):
                    try:
                        ...
                        print(error_message)
                if not os.path.exists('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/describeCtx_page/'+subdirectory):
                    os.makedirs('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/describeCtx_page/'+subdirectory)
                with open('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/describeCtx_page/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                    json.dump(result,f)