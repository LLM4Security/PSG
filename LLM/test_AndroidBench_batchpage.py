...
for subdirectory in tqdm(subdirectories):
    ...
    if os.path.exists(path+'uiHtml.json') and os.path.exists(path+'/cfgs'):
        try:
            ...
            path = '/home/jiuyan/PPG/AndroidBench_batch2_codesummary/'+subdirectory
            result = {}
            ...
            for i in tqdm(ui_dic.keys()):
                ...
                if os.path.exists(path+'/'+i):
                    ...
                    print(response)
                    result[i] = response
                if not os.path.exists('/home/jiuyan/PPG/AndroidBench_page_batch/'+subdirectory):
                    os.makedirs('/home/jiuyan/PPG/AndroidBench_page_batch/'+subdirectory)
                with open('/home/jiuyan/PPG/AndroidBench_page_batch/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                    json.dump(result,f)
