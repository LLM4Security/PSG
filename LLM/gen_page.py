...
# 指定目录的路径
directory_path = "/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DeUEDroid_result/Gambling"
...
for subdirectory in subdirectories:
    ...
    if os.path.exists(path+'uiHtml.json') and os.path.exists(path+'/cfgs'):
        ...
        path = '/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DeUEDroid_abstract/Gambling/'+subdirectory
        result = {}
        ...
        for i in tqdm(ui_dic.keys()):
            ...
            if os.path.exists(path+'/'+i):
                ...
                print(response)
                result[i] = response
            if not os.path.exists('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DeUEDroid_page/Gambling/'+subdirectory):
                os.makedirs('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DeUEDroid_page/Gambling/'+subdirectory)
            with open('/mnt/maldect_ssd_2T/PPG_dataset/PPG_dataset/DeUEDroid_page/Gambling/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                json.dump(result,f)
