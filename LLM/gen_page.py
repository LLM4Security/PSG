...
for subdirectory in subdirectories:
    ...
    if os.path.exists(path+'uiHtml.json') and os.path.exists(path+'/cfgs'):
        ...
        path = '/home/jiuyan/PPG/AndroidBench_func_abstract/'+subdirectory
        result = {}
        ...
        for i in tqdm(ui_dic.keys()):
            ...
            if os.path.exists(path+'/'+i):
                ...
                print(response)
                result[i] = response
            if not os.path.exists('/home/jiuyan/PPG/AndroidBench_page_abstract/'+subdirectory):
                os.makedirs('/home/jiuyan/PPG/AndroidBench_page_abstract/'+subdirectory)
            with open('/home/jiuyan/PPG/AndroidBench_page_abstract/'+subdirectory+'/page.json','w', encoding='utf-8') as f:
                json.dump(result,f)
