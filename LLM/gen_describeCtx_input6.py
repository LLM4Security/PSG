...
logging.basicConfig(filename='error6_log.txt', level=logging.ERROR)
...
apk_name = apk_name[900:1000]

time_limit_per_app = 20*60

app_processing_log = './describeCtx_time6.log'
        ...
        for file in tqdm(file_list):
            ...
            for i in doc_result.keys():
                ...
                try:
                    ...
                    # Optionally, # print the error message to the console
                    # print(error_message)
            if not os.path.exists('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_abstract/'+subdirectory):
                os.makedirs('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_abstract/'+subdirectory)
            with open('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_abstract/'+subdirectory+'/'+file.replace('/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/PSG_dataset/describeCtx_template/'+subdirectory+'/', ''), 'w', encoding='utf-8') as f:
