...
if __name__ == "__main__":
    # 指定目录路径
    # /cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/backdoor/top500_decompile
    directory_path = "/cpfs01/projects-SSD/cfff-5822cced0fd0_SSD/cxy_22210240138/PSG/PSG/backdoor/2FA_decompile"

    # 获取目录下所有Java文件的完整路径
    java_file_paths = get_java_file_paths(directory_path)

    # 指定输出文件路径
    output_file_path = "./2FA_decompile_java_path.txt"
